<?php 
/**Archivo Raiz de la entidad estatus**/

//librerias
require_once 'app/controller/cabecera.inc.php';
require_once 'app/controller/mvc.controllerEstatus.php';
$mvc = new mvc_controllerEstatus();
...
if($accion === 'crear'){
   ...
   $mvc->Actualizar();
}else if ($accion === 'ActualizarSupervisor'){
   $mvc->ActualizarSupervisor();
