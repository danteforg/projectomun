<?php 
/**Archivo Raiz de la entidad clasificaciontramite**/

//librerias
require_once 'app/controller/cabecera.inc.php';
require_once 'app/controller/mvc.controllerClasificaciontramite.php';
$mvc = new mvc_controllerClasificaciontramite();
